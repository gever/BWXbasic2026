...
export const SYNTAX = {
    ...
    classify: (token) => {
        ...
        if (['SIN', 'COS', 'TAN', 'ATN', 'EXP', 'LOG', 'SQR', 'ABS', 'INT', 'RND', 'RAND', 'LEN', 'LEFT$', 'RIGHT$', 'MID$', 'STR$', 'VAL', 'INKEY', 'INKEY$', 'TIME', 'INSTR', 'GR_CANVAS', 'GR_GET_CANVAS', 'GR_CANVAS_WIDTH', 'GR_CANVAS_HEIGHT'].includes(tu)) return SYNTAX.colors.FUNCTION;
