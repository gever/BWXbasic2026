export const LIB = {
    ...
    'STR$': '(val) => String(typeof IO !== "undefined" ? IO.format(val) : val)', 'STR': '(val) => String(typeof IO !== "undefined" ? IO.format(val) : val)', 'VAL': '(s)=>{const v=parseFloat(s); return isNaN(v)?0:v;}',
