...
2840 HTAB 8 : PRINT :R1=I:GOSUB 8790:PRINT G2$;" REPAIR COMPLETED."
...
3170 FOR I=1T ON:S1=S1+X1:S2=S2+X2:IF S1<1 OR S1>=9 OR S2<1 OR S2>=9 THEN 3500
...
6140 R1=FNR(1):D(R1)=D(R1)-H/S-.5*RND(1):GOSUB goto 8790
...
7542 REM IFA$="Y"THEN POKE1229,2:POKE1237,3:NULL1
7543 PRINT:PRINT"        ";
...
7740 Z4=I:Z5=1:GOSUB 9030:J0=INT(15-.5*LEN(G2$)):HTAB J0 : PRINT G2$;
7800 Z5=5:GOSUB 9030:J0=INT(39-.5*LEN(G2$)):HTAB J0 : PRINT G2$;
...
8590 R1=FNR(1):R2=FNR(1):A$="   ":Z1=R1:Z2=R2:GOSUB 8830:IF Z3=0 THEN goto 8590
8600 RETURN
